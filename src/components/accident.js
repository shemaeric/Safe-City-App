...
class Accident extends Component {
  ...
  handleImageChoose = async () => {
    ...
    ImagePicker.showImagePicker(options, response => {
      this.setState({attached_file: 'https://image.shutterstock.com/image-photo/legs-person-lying-on-road-600w-1029955816.jpg'})
...
export default connect(mapStateToProps, {sendRequest})(Accident);
