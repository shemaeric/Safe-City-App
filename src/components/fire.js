...
class Fire extends Component {
  ...
  handleImageChoose = async () => {
    ...
    ImagePicker.showImagePicker(options, response => {
      this.setState({attached_file: 'https://www.healthandsafetyhandbook.com.au/wp-content/uploads/2014/08/fire.jpg'})
...
export default connect(mapStateToProps, {sendRequest})(Fire);
